...
void QuantifiersEngine::declareProjVar(Node v) { d_treg.declareProjVar(v); }

void QuantifiersEngine::declareWeight(Node v, uint32_t weight)
{
  d_treg.declareWeight(v, weight);
}
